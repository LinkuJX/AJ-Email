...
function EmailCtrl($scope, $http, $filter) {
    ...
    $scope.email = {
        ...
        idRequired: {
            ...
            card:       { selected: false, text: 'Proof of the card ending', aditionalInfo: function() { return ' ' + $scope.email.cannotAccept.cardNumber + ' which has been used to deposit on your account. We require to see is the first 6 and last 4 digits on the front of the card along with the card holder’s name and the expiry date. Please block out the middle 6 digits of the long 16-digit card number for security.' } },
            cardNumber: '', // start as string so the placeholder is shown
            pop:        { selected: false, text: 'Confirmation to show your phone bill for number ending',          aditionalInfo: function() { return $filter('date')($scope.email.cannotAccept.date, "dd/MM/yyyy"); } },
            thirdParty: { selected: false, text: 'Confirmation to show the 3rd party phone bill for number ending', aditionalInfo: function() { return $filter('date')($scope.email.cannotAccept.date, "dd/MM/yyyy"); } },
            ...
            thirdPartyCard: { selected: false, text: 'Proof of the 3rd party card ending', aditionalInfo: function() { return ' ' + $scope.email.cannotAccept.thirdPartyCardNumber + ' which has been used to deposit on your account. We require to see is the first 6 and last 4 digits on the front of the card along with the card holder’s name and the expiry date. Please block out the middle 6 digits of the long 16-digit card number for security.' } },
            thirdPartyCardNumber: '', // start as string so the placeholder is shown
